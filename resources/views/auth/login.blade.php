...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-indigo-100">Sign in to continue learning</p>
        </div>

        <!-- Login Card -->
        <div class="bg-white rounded-3xl card-shadow p-8">
            <!-- Success Message -->
            <div class="mb-4 p-3 bg-green-50 border border-green-200 rounded-xl text-green-700 text-sm hidden" id="status-message">
            ...
            <p class="text-center text-sm text-gray-600 mt-6">
                ...
                <a href="#" class="text-indigo-600 hover:text-indigo-700 font-semibold">Create account</a>
            </p>
        </div>
